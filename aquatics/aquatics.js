...
window.onload = function () {
  ...
  function startGame() {
    //day = 4;
    //initialise sounds
  blop = new sound("assets/sfx/fish.mp3");
  rareBlop = new sound("assets/sfx/rare-fish.mp3");
  trashSound = new sound("assets/sfx/trash.mp3");
  bzzt = new sound("assets/sfx/bzzt.mp3");
  bite = new sound("assets/sfx/bite.mp3");
  bgm = new sound("assets/sfx/Bug_Catching.mp3");
    bgm.play();
    if (day === 0) {
