...
let player1 = {current:0, target:0, x:0, y:0, colour:'#f36d', id:'Tú turno'};
let player2 = {current:0, target:0, x:0, y:0, colour:'#8a2d', id:'Bot'};
...
const rollDice = (evt) => {
	...
	message.innerHTML = activePlayer === player1 ? "Lanzando..." : 'Auto bot lanzando...';
